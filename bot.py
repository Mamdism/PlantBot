...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if section in ["treatment", "care"]:
        ...
        try:
            ...
            کاربر داره درباره {section}  و امکان وسطش عکس رو بفرسته هرجا صحبت از عکس شد مثلا گفت عکس رو فرستادم تو باید بگی متخصصمون چک میکنه و بهت اطلاع میده و درباره گیاهش بهش بگی که نگران نباشه و از این نوع کمک ها گیاهش حرف می‌زنه.
            آخرین پیامش: "{text}".
